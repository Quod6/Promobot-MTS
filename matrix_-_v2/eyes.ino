...
{
   matrix.fillScreen(LOW);
   matrix.drawBitmap(0, 0, sad1_1, 8, 16, 1);
   matrix.drawBitmap(8, 0, sad1_2, 8, 16, 1);
   matrix.drawBitmap(16, 0, sad2_1, 8, 16, 1);
   matrix.drawBitmap(24, 0, sad2_2, 8, 16, 1);
   matrix.write();
   delay(400);
   glaza();
}
...
{
   matrix.fillScreen(LOW);
   matrix.drawBitmap(0, 0, xx1, 8, 16, 1);
   matrix.drawBitmap(8, 0, xx2, 8, 16, 1);
   matrix.drawBitmap(16, 0, xx1, 8, 16, 1);
   matrix.drawBitmap(24, 0, xx2, 8, 16, 1);
   matrix.write();
   delay(400);
   glaza();
}
